    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ParentStoryId = c.Int(nullable: false),
                ...
                .ForeignKey("dbo.Stories", t => t.ParentStoryId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId)
                .Index(t => t.ParentStoryId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Stories", "UserId", "dbo.AspNetUsers");
